/* **************************************************************************************
 * Filename: user_selection3.cpp.
 * Author: Lodewyk Jansen van Rensburg.
 * Student ID: 934 309 717.
 * Date: October 11, 2020.
 * Description: This is the implementation file for my the user selection section
 ...
 * Description: This function is used to print an array of spells.
 * Parameters: spell* and int.
 * Pre-conditions: The array of spells needs to contain valid spelldata.
 * Post-conditions: The array of spells is printed to the screen. 
 * **************************************************************************************/
...
std::string get_options(){
	std::cout << std::endl << "Please select the integer associated with"
		<< " the action that you want the program to perfrom.\n" << std::endl;
...
void print_or_write(library* lib, wizard* wiz, std::string option){
	...
	}else{std::cout << "ERROR: print_or_write()\n";}
}
/* **************************************************************************************
...
std::string User_option(library* lib, wizard* wiz){
	...
	if(option == "1"){
		...
		std::cout << "Goodbey! Hope to see you again soon!" << std::endl;	
		return "quit";	
	}else{
